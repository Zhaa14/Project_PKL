  ...
  <div class="container" data-aos="fade-up"><br>
    @include('layouts._flash')
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="post-box">
              <div class="post-img"><img src="images/header.png" class="img-fluid" alt=""></div>
            </div>
          </div>
      </div>
  </section><!-- End Hero -->
        ...
        <div class="row">
          @foreach ($informasi as $itam)
            ...
            <div class="post-box">
              ...
              <a href="artikel/{{$itam->id}}" class="readmore stretched-link mt-auto"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
          @endforeach
        </div>
